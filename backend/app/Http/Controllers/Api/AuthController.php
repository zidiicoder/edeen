    ...
    private function issueOtp(string $email, string $purpose): void
    {
        ...
        try {
            ...
            Log::info("✅ OTP email sent successfully", [
                'email' => $email,
                'purpose' => $purpose,
                'code' => $code, // Include code in logs for debugging
            ]);
            ...
            Log::error("❌ Failed to send OTP email", [
                'email' => $email,
                'purpose' => $purpose,
                'code' => $code, // Include code so admin can manually send
                'error' => $e->getMessage(),
                'trace' => $e->getTraceAsString(),
            ]);
            
            // Always log the code when email fails (so users can still verify)
            Log::warning("📧 EMAIL FAILED - OTP Code for manual verification", [
                'email' => $email,
                'code' => $code,
                'purpose' => $purpose,
            ]);
